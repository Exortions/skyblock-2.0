...
public class WandOfMending extends ListeningItem {
    private final int healingAmount = 100;
    private final int cooldown = 1;
    
    public WandOfMending(Skyblock plugin) {
        super(plugin.getItemHandler().getItem("WAND_OF_MENDING.json"), "wand_of_mending");
    }
