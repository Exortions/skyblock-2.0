...
public class GravelMinion extends MiningMinion {
    public GravelMinion() {
        this(UUID.randomUUID());
    }
    public GravelMinion(UUID uuid) {
        super(uuid, "Gravel", "mining", Color.BLACK, Material.GRAVEL);
    ...
    public ArrayList<ItemStack> calculateDrops(int level) {
        return new ArrayList<ItemStack>(Arrays.asList(new ItemStack(Material.GRAVEL)));
