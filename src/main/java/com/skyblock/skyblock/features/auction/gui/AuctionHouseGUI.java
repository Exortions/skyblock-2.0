...
public class AuctionHouseGUI extends Gui {
    ...
    public AuctionHouseGUI(Player player) {
        ...
        if (bid > 0) {
            bids.addLore("&7You placed " + ChatColor.GREEN + bid + " bids &7on", "&7pending auctions", " ", "&7You hold the top bid on", "(" + ChatColor.YELLOW + top + "&7/" + ChatColor.YELLOW + bid + "&7) of these", "auctions");
        } else {
